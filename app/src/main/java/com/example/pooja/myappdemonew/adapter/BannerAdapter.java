...
public class BannerAdapter extends RecyclerView.Adapter<BannerAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_banner, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        holder.tv_name.setText((CharSequence) mList.get(position));
     //   holder.iv_photo.setBackgroundDrawable(mList.get(position).getPhoto());
    }
